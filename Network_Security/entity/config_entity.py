...
class TrainingPipelineConfig:                            # the General configuration for all the pipelines
...
'''
This class depends on TrainingPipelineConfig and defines all paths and parameters needed specifically for the data ingestion step.
'''
