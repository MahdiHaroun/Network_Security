...
import dagshub
dagshub.init(repo_owner='MahdiHaroun', repo_name='Network_Security_Project', mlflow=True)
...
class ModelTrainer:
    ...
    def track_mlflow_combined(self, best_model, train_metric, test_metric):
        ...
        with mlflow.start_run():
            ...
            logger.info("Combined train/test metrics logged to MLflow in single run.")
    ...
    def train_model(self,X_train,y_train,x_test,y_test):
        ...
        ## Track the experiements with mlflow - single run with both train and test metrics
        self.track_mlflow_combined(best_model, classification_train_metric, classification_test_metric)
