...
DATA_INGESTION_DATABASE_NAME: str = "MahdiHaroun"
...
SAVED_MODEL_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), "saved_models")
